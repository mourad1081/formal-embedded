...
Cette propri\u00e9te DOIT etre verifie
*/
A[] not deadlock
...
La propri\u00e9t\u00e9 NE DOIT PAS \u00eatre satisfaite.
*/
...
cette propri\u00e9t\u00e9 DOIT ETRE SATISFAITE
*/
A[] (not(x > 80) or (slow.Green or normal.Green or high.Green))

/*
S'il a la possibilité d'optimiser en lancant trois voitures à la suite (rapide -> normal -> lente), alors dans le futur il le fera
- Cette propri\u00e9t\u00e9 DOIT \u00eatre satisfaite.
*/
ctrl.Consulted and traffic_gr[0] > 0 and free[0] and traffic_gr[1] > 0 and free[1] and traffic_gr[2] > 0 and free[2] and turn == 2 --> ctrl.GGG

/*
S'il a la possibilité d'optimiser en lancant deux voitures à la suite (rapide -> lente), alors dans le futur il le fera
- Cette propri\u00e9t\u00e9 DOIT \u00eatre satisfaite.
*/
ctrl.Consulted and traffic_gr[0] > 0 and free[0] and traffic_gr[2] > 0 and free[2] and turn == 2 --> ctrl.GRG

/*
S'il a la possibilité d'optimiser en lancant deux voitures à la suite (rapide -> normal), alors dans le futur il le fera
- Cette propri\u00e9t\u00e9 DOIT \u00eatre satisfaite.
*/
ctrl.Consulted and traffic_gr[1] > 0 and free[1] and traffic_gr[2] > 0 and free[2] and turn == 2 --> ctrl.RGG

/*
S'il a la possibilité d'optimiser en lancant deux voitures à la suite (normal -> lente), alors dans le futur il le fera
- Cette propri\u00e9t\u00e9 DOIT \u00eatre satisfaite.
*/
ctrl.Consulted and traffic_gr[0] > 0 and free[0] and traffic_gr[1] > 0 and free[1] and turn == 1 --> ctrl.GGR
